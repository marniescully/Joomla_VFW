...
if(show0 || show2 )
{
document.getElementById('startf').parentNode.parentNode.setAttribute('style','display:none');
...
if(show1 && showd1)
{
if(document.getElementById('startf').parentNode.parentNode.childNodes[3].value=='')
